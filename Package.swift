...
let package = Package(
    ...
    products: [
        ...
        .library(name: "ObjectMapper_Bayut", targets: ["ObjectMapper"]),
        .library(name: "AlamofireObjectMapper_Bayut", targets: ["AlamofireObjectMapper"]),
        .library(name: "ImageSlideshow_Bayut", targets: ["ImageSlideshow"]),
        .library(name: "ImageSlideshowAlamofire_Bayut", targets: ["ImageSlideshowAlamofire"]),
        .library(name: "ImageSlideshowSDWebImage_Bayut", targets: ["ImageSlideshowSDWebImage"]),
        .library(name: "ImageSlideshowKingfisher_Bayut", targets: ["ImageSlideshowKingfisher"]),
